...
START_OTHER_USERS_TEXT = get_config(
    ...
    (
        ...
        "This is a bot only for talk to my Master @i420Smoker\n\n"
        "You Need Create Private Bot? Please Talk Here, And Type <i>Bot202</i>\n\n\n"
        ...
        "ℹ️ Subscribe @i420Smoker if you 😍 using this bot❗️❣️"
    )
)
